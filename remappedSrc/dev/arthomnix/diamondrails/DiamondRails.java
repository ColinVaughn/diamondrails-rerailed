...
public class DiamondRails implements ModInitializer {
    public static final Block DIAMOND_RAIL = new PoweredRailBlock(FabricBlockSettings.create(Material.DECORATION)
            .sounds(BlockSoundGroup.METAL)
            .strength(0.7f)
            .noCollision()
    );

    public static final Block ENHANCED_DIAMOND_RAIL = new PoweredRailBlock(FabricBlockSettings.create(Material.DECORATION)
            .sounds(BlockSoundGroup.METAL)
            .strength(0.7f)
            .noCollision()
    );

    public static final Block NETHERITE_RAIL = new PoweredRailBlock(FabricBlockSettings.create(Material.DECORATION)
            .sounds(BlockSoundGroup.METAL)
            .strength(0.7f)
            .noCollision()
    );
